...
<main id="local-partner-page" class="main-content">
    ...
    <section class="local-partner-intro">
        <div class="container">
            <h2 class="page-section-title">地域パートナー</h2>
            <p class="section-description">
                各地域のプロジェクトオーナーとしてセカンドレストランに参画している"地域パートナー"をご紹介します。その地域だからこそ生まれる唯一無二の「美味しい時間」によって、地域の新たな魅力を育てます。
            </p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="filter-bar">
                ...
                <div class="filter-tags">
                    <a href="<?php echo get_post_type_archive_link('local_partner'); ?>" class="tag <?php echo !isset($_GET['partner_category']) ? 'active' : ''; ?>">#すべて</a>
                    <?php
                    ...
                    if (!empty($terms) && !is_wp_error($terms)) :
                        foreach ($terms as $term) :
                            $active_class = (isset($_GET['partner_category']) && $_GET['partner_category'] === $term->slug) ? 'active' : '';
                    ?>
