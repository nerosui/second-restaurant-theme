	...
	<section class="hero-section">
		<div class="hero-container">
			<picture class="hero-background">
				<source media="(max-width: 768px)" srcset="images/join-hero-bg-sp.png">
				<img src="images/join-hero-bg-pc.png" alt="">
			</picture>
			...
			<div class="benefits-content">
				<div class="benefit-item">
					<div class="benefit-image benefit-image-local">
						<img src="images/join_local-partner.jpg" alt="Local Partner Icon" width="240" height="240">
					</div>
				...
				<div class="benefit-item">
					<div class="benefit-image benefit-image-chef">
						<img src="images/join_traveling-chef.jpg" alt="Traveling Chef Icon" width="240" height="240">
					</div>
				...
				<div class="role-item">
					<div class="role-badge">
						...
						<div class="role-icon role-icon-local">
							<img src="images/join_local-partner-icon.svg" alt="Local Partner Icon" width="85" height="90">
						</div>
					</div>
				...
				<div class="role-item">
					<div class="role-badge">
						...
						<div class="role-icon role-icon-chef">
							<img src="images/join_traveling-chef-icon.svg" alt="Traveling Chef Icon" width="57" height="70">
						</div>
					</div>
					<div class="role-description">
		...
		<div class="container">
			...
			<div class="flow-notice">
				...
				<a href="#" class="line-button">
					<div class="line-icon">
						<img src="images/line-icon.svg" alt="LINE Icon" width="24" height="24">
					</div>
					...
					<div class="step-content">
						<div class="step-title-wrapper">
							<div class="step-icon step-icon-form">
								<img src="images/join_form-icon.svg" alt="Form Icon" width="24" height="44">
							</div>
					...
					<div class="step-content">
						<div class="step-title-wrapper">
							<div class="step-icon step-icon-meeting">
								<img src="images/join_meeting-person-icon.svg" alt="Meeting Person Icon" width="40" height="36">
							</div>
					...
					<div class="step-content">
						<div class="step-title-wrapper">
							<div class="step-icon step-icon-entry">
								<img src="images/join_entry-icon.svg" alt="Entry Icon" width="24" height="44">
							</div>
					...
					<div class="step-content">
						<div class="step-title-wrapper">
							...
							<div class="step-icon step-icon-review">
								<img src="images/join_review-icon-group.svg" alt="Review Icon" width="32" height="40">
							</div>
					...
					<div class="step-content">
						<div class="step-title-wrapper">
							...
							<div class="step-icon step-icon-confirm">
								<img src="images/join_check-icon.svg" alt="Check Icon" width="40" height="24">
							</div>
